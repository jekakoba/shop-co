...
/*************  ✨ Codeium Command ⭐  *************/
/**
 * Toggle the visibility of the filter and lock the body from scrolling.
 * Add event listener to the filter button to toggle the classes.
 * Add event listener to the document to close the filter when click outside.
 * @function

/******  8f34407f-e705-4dfe-80d2-f3ce0e439020  *******/
function showFilter() {
	...
	function closeFilter() {
		document.addEventListener('click', (e) => {
			e.target.closest('[data-close-filter]') || e.target.closest('[data-filter]')
		})
	}
	closeFilter()
}
